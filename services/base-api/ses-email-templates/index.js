...
const templateList = [
  {
    ...
    templateSubject: '[use-reducer-login] Your use-reducer-login Pro membership payment has failed 😢',
  },
  {
    templateId: 'subscription-ended',
    templateSubject: '[use-reducer-login] Your use-reducer-login Pro membership has come to an end 😢',
  },
];
